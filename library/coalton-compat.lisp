...
(pushnew
 (if (>= #x7F cl:most-positive-fixnum)
     (intern "COALTON:8-BIT-FIXNUM" "KEYWORD")
     (if (>= #x7FFF cl:most-positive-fixnum)
         (intern "COALTON:16-BIT-FIXNUM" "KEYWORD")
         (if (>= #x7FFFFFFF cl:most-positive-fixnum)
             (intern "COALTON:32-BIT-FIXNUM" "KEYWORD")
             (if (>= #x7FFFFFFFFFFFFFFF cl:most-positive-fixnum)
                 (intern "COALTON:64-BIT-FIXNUM" "KEYWORD")
                 (error "Unknown fixnum size")))))
 cl:*features*)
