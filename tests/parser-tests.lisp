...
(deftest test-parser-test-files ()
  ...
  (run-test-file "tests/parser-test-files/parse-and.txt")
  (run-test-file "tests/parser-test-files/parse-attribute.txt")
  (run-test-file "tests/parser-test-files/parse-body.txt")
  (run-test-file "tests/parser-test-files/parse-break.txt")
  (run-test-file "tests/parser-test-files/parse-cond.txt")
  (run-test-file "tests/parser-test-files/parse-continue.txt")
  (run-test-file "tests/parser-test-files/parse-declare.txt")
  (run-test-file "tests/parser-test-files/parse-let.txt")
  (run-test-file "tests/parser-test-files/parse-toplevel.txt")
