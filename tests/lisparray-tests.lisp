...
(define-test array-constructing-instances ()
  ...
  ;; Some edge cases
  (is (== (array:make 0 0)
          (the (array:LispArray Integer) (unfold (fn (_) None) 0))))
  (is (== (array:make 0 0)
          (the (array:LispArray Integer) (unfoldr (fn (_) None) 0))))
  (is (== (array:make 0 0)
          (the (array:LispArray Integer) (tabulate (fn (_) 0) 0))))
  )
