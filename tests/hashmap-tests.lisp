...
(define-test simple-hashmap ()
  ...
  (is (== (Some 1) (hashmap:get e "alpha")))
  (is (== (Some 2) (hashmap:get e "beta")))
  (is (== (Some 3) (hashmap:get e "gamma")))
  (is (== (Some 4) (hashmap:get e "delta")))
  (is (== None (hashmap:get e "epsilon")))

  (let f = (hashmap:insert e "alpha" 5))
  (is (== (Some 5) (hashmap:get f "alpha")))

  (let g = (hashmap:remove f "beta"))
  (is (== (Some 5) (hashmap:get g "alpha")))
  (is (== None (hashmap:get g "beta")))
  (is (== (Some 3) (hashmap:get g "gamma")))
  (is (== (Some 4) (hashmap:get g "delta")))
