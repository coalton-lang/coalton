...
(define-test iter-downfrom ()
  ...
  (is (== (the (List Integer) (make-list 9 8 7 6 5 4 3 2 1 0))
          (iter:collect! (iter:down-from 10))))
  (is (== (the (List UFix) (make-list 3 1))
          (iter:collect! (iter:range-decreasing 2 5 0))))
  (is (== (the (List UFix) (make-list 1))
          (iter:collect! (iter:range-decreasing 2 3 0))))
  (is (== (the (List UFix) Nil)
          (iter:collect! (iter:range-decreasing 2 1 0))))
  (is (== (the (List Integer) (make-list 9 8 7 6 5 4 3 2 1 0))
