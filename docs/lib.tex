...
Build and test the secondary libraries in a separate, optional phase.

Maybe 'math' (and all of its subpackages) is the 'premiere' secondary
library. What in primary might depend on it?

Discussion of IO and the difficulty of writing simple parsers, like,
for common stuff, like CSV.

Put regular expressions into the standard library, i.e., wrap CL-PPCRE.
