...
(defmacro define-pprint-codegen-macro (codegen)
  "Generate a pretty-printing macro for codegen macros."
  `(defmacro ,(intern (format nil "~A-~A" (string '#:pprint) codegen) '#:coalton)
       (&body forms)
...
(define-pprint-codegen-macro coalton:coalton-codegen)
(define-pprint-codegen-macro coalton:coalton-codegen-types)
(define-pprint-codegen-macro coalton:coalton-codegen-ast)
