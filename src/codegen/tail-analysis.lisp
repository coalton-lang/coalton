;;; Look at the nodes in tail position of a function node.
...
(defun map-tail-nodes (f top-node)
  "Map the unary function F on the innermost nodes in tail position of
the node TOP-NODE. If TOP-NODE is an abstraction, then its body will
be inspected."
