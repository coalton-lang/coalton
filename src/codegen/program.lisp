...
(defun definition-bindings (definitions env offsets)
  "Translate the DEFINITIONS in this TU into a list of bindings, updating an OFFSETS hastable to record the source offset of each binding's source definition."
...
(defun instance-bindings (instances env offsets)
  "Translate the INSTANCES defined by this TU into a list of bindings, updating an OFFSETS hastable to record the source offset of each binding's source instance."
